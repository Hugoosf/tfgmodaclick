...
<div class="container-fluid">
    ...
    <header>
        <h1 style="margin-top:15px; ">Bienvenido, <?php echo e($user->nombre); ?>!</h1>
        <div class="row objetin">
        <div class="col-12 col-md-6 avatar">
            <form action="<?php echo e(route('guardar.prenda')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            <div class="personaje">
...
<span class="salto"></span>
    ...
    <nav id="paginacion2" style="display: block; margin: 0 auto; width: fit-content;"></nav>
        ...
        <div class="row lista" id="contenido-prendas">
            <?php echo $__env->make('partials.lista_prendas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php echo $__env->make('layouts.plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tfg\modaclick\resources\views/bienvenido.blade.php ENDPATH**/ ?>